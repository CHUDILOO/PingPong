...
racket1 = Player("racket1.png",30,200,12,120,16)
racket2 = Player("racket2.png",550,200,12,120,16)
...
while game:
    for e in event.get():
        ...
        if not finish :
            ...
            if score1 > 10:
                lose = font.render("PLAYER 2 LOX!", True, (180,0,0))
                finish = True
                window.blit(lose, (250,200))

            if score2 > 10:
                lose = font.render("PLAYER 1 LOX!", True, (180,0,0))
                finish = True
                window.blit(lose, (250,200))
